...
public class GD_HuyDatPhongCho extends JDialog implements ActionListener {
    ...
    public GD_HuyDatPhongCho() {
        ...
        btnXoaPhieu.setFont(new Font("Tahoma", Font.BOLD, 13));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (o.equals(btnXoaPhieu)) {
            if (maHoaDonSelected != null) {
                ...
                JOptionPane.showMessageDialog(this, "Hãy chọn một phòng để hủy", "Thông báo", JOptionPane.WARNING_MESSAGE);
            }
            TimKiem();
