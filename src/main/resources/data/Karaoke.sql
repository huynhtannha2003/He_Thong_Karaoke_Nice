...
INSERT INTO Phong
VALUES ('P0101', '01.001', 10, 'LP001', 0), ('P0102', '01.002', 10, 'LP001', 0), ('P0103', '01.003', 10, 'LP001', 0), ('P0104', '01.004', 10, 'LP001', 0), ('P0105', '01.005', 10, 'LP001', 0)

INSERT INTO Phong
VALUES ('P0201', '02.001', 10, 'LP002', 0), ('P0202', '02.002', 10, 'LP002', 0), ('P0203', '02.003', 10, 'LP002', 0), ('P0204', '02.004', 10, 'LP002', 0), ('P0205', '02.005', 10, 'LP002', 0)
    GO

INSERT INTO LichSuGiaPhong
VALUES ('GP.041123.01', '2018-01-01', NULL, '6:00', '12:00', 100000, 'LP001'), ('GP.041123.02', '2018-01-01', NULL, '18:00', '23:00', 200000, 'LP002')
    GO

INSERT INTO NhanVien
VALUES ('NV230001', N'Trần Trung Tiến', N'Người quản lý', '0986148209', N'tien@gmail.com', N'12 Nguyễn Văn Bảo, Gò Vấp, Hồ Chí Minh', 1), ('NV230002', N'La Minh Tâm', N'Người quản lý', '0886700046', N'tam@gmail.com', N'12 Nguyễn Văn Bảo, Gò Vấp, Hồ Chí Minh', 1), ('NV230003', N'Vũ Quốc Huy', N'Nhân viên', '0366895412', N'huy@gmail.com', N'12 Nguyễn Văn Bảo, Gò Vấp, Hồ Chí Minh', 1), ('NV230004', N'Lương Tấn Đạt', N'Nhân viên', '0962145578', N'dat@gmail.com', N'12 Nguyễn Văn Bảo, Gò Vấp, Hồ Chí Minh', 1)
    GO

INSERT INTO TaiKhoan
VALUES ('TK23001', N'trantrungtien', N'Tien123456@', 1, 'NV230001'), ('TK23002', N'laminhtam', N'Tam123456@', 1, 'NV230002'), ('TK23003', N'vuquochuy', N'Huy123456@', 1, 'NV230003'), ('TK23004', N'luongtandat', N'Dat123456@', 1, 'NV230004')
    GO

INSERT INTO LoaiDichVu
VALUES ('LDV001', N'Thực phẩm', 1), ('LDV002', N'Nước uống', 1)
    GO

INSERT INTO DichVu
VALUES ('DV.001.001', N'Trái cây', 20, 'LDV001', 1, '/image/dichVu/traicay.png'), ('DV.001.002', N'Mỳ xào hải sản', 10, 'LDV001', 1, '/image/dichVu/myxao.png'), ('DV.001.003', N'Cá điêu hồng chiên xù', 15, 'LDV001', 1, '/image/dichVu/caDieuHong.png'), ('DV.001.004', N'Bánh ngọt', 30, 'LDV001', 1, '/image/dichVu/banhNgot.png'), ('DV.001.005', N'Bánh kem', 10, 'LDV001', 1, '/image/dichVu/banhKem.png'), ('DV.002.001', N'Coca Cola', 420, 'LDV002', 1, '/image/dichVu/cocaCola.png'), ('DV.002.002', N'Heniken', 320, 'LDV002', 1, '/image/dichVu/heineiken.png'), ('DV.002.003', N'Sting', 100, 'LDV002', 1, '/image/dichVu/sting.png'), ('DV.002.004', N'Trà ô long', 50, 'LDV002', 1, '/image/dichVu/traOLong.png'), ('DV.002.005', N'Wine', 30, 'LDV002', 1, '/image/dichVu/wine.png')
    GO

INSERT INTO LichSuGiaDichVu
VALUES ('GDV.041123001', '2018-01-01', NULL, '6:00', '12:00', 80000, 'DV.001.001'), ('GDV.041123002', '2018-01-01', NULL, '6:00', '12:00', 120000, 'DV.001.002'), ('GDV.041123003', '2018-01-01', NULL, '12:00', '18:00', 100000, 'DV.001.003'), ('GDV.041123004', '2018-01-01', NULL, '12:00', '18:00', 40000, 'DV.001.004'), ('GDV.051123001', '2018-01-01', NULL, '18:00', '23:00', 150000, 'DV.001.005'), ('GDV.051123002', '2018-01-01', NULL, '18:00', '23:00', 20000, 'DV.002.001'), ('GDV.061123001', '2018-01-01', NULL, '6:00', '12:00', 560000, 'DV.002.002'), ('GDV.061123002', '2018-01-01', NULL, '6:00', '12:00', 18000, 'DV.002.003'), ('GDV.061123003', '2018-01-01', NULL, '6:00', '12:00', 15000, 'DV.002.004'), ('GDV.061123014', '2018-01-01', NULL, '6:00', '12:00', 830000, 'DV.002.005')
    GO

INSERT INTO KhuyenMai
VALUES ('KM.041123.001', N'Happy time', 20, 5, '2023-11-04', '2023-11-20', '8:00', '23:00'), ('KM.051123.002', N'Cùng vui sinh nhật', 20, 10, '2023-11-05', '2023-11-05', '9:00', '21:00'), ('KM.061123.003', N'Đầu tuần', 50, 3, '2023-11-06', '2023-11-06', '6:00', '23:00'), ('KM.071123.004', N'Sáng thứ 3 ưu đãi', 30, 10, '2023-11-07', '2023-11-07', '6:00', '12:00'), ('KM.081123.005', N'Buổi tối vào hội', 20, 5, '2023-11-08', '2023-11-08', '18:00', '21:00')
    GO

INSERT INTO KhachHang
VALUES ('KH.041123.001', N'Nguyễn Văn A', '0345678912'), ('KH.041123.002', N'Nguyễn Văn B', '0345678913'), ('KH.051123.001', N'Nguyễn Văn C', '0345678914'), ('KH.051123.002', N'Nguyễn Văn D', '0345678915'), ('KH.061123.001', N'Nguyễn Văn E', '0345678916'), ('KH.061123.002', N'Nguyễn Văn F', '0345678917'), ('KH.061123.003', N'Nguyễn Văn G', '0345678918'), ('KH.061123.004', N'Nguyễn Văn H', '0345678919')
    GO

INSERT INTO HoaDon
VALUES ('HD.040123.001', 800000, '2023-01-04', '18:00', 'KH.041123.001', 'NV230003', 'KM.041123.001'), ('HD.040123.002', 120000, '2023-01-04', '12:00', 'KH.041123.002', 'NV230001', NULL), ('HD.050123.001', 300000, '2023-01-05', '9:00', 'KH.051123.001', 'NV230002', NULL), ('HD.050523.002', 520000, '2023-05-05', '22:00', 'KH.051123.002', 'NV230002', NULL), ('HD.060523.001', 180000, '2023-05-06', '21:00', 'KH.041123.001', 'NV230004', NULL), ('HD.060523.002', 420000, '2023-05-06', '15:00', 'KH.041123.002', 'NV230002', NULL), ('HD.060723.001', 100000, '2023-07-06', '10:00', 'KH.041123.002', 'NV230001', NULL), ('HD.070723.001', 800000, '2023-07-07', '15:00', 'KH.061123.004', 'NV230003', NULL)
    GO

INSERT INTO PhieuDatPhong
VALUES ('PDP.040123.0001', '15:00', '18:00', 'HD.040123.001', 'P0101'), ('PDP.040123.0002', '10:00', '12:00', 'HD.040123.002', 'P0203'), ('PDP.050123.0001', '8:00', '9:00', 'HD.050123.001', 'P0102'), ('PDP.050523.0001', '15:00', '22:00', 'HD.050523.002', 'P0202'), ('PDP.060523.0001', '18:00', '21:00', 'HD.060523.001', 'P0101'), ('PDP.060523.0002', '12:00', '15:00', 'HD.060523.002', 'P0204'), ('PDP.060723.0001', '8:00', '10:00', 'HD.060723.001', 'P0205'), ('PDP.070723.0001', '10:00', '15:00', 'HD.070723.001', 'P0105')
    GO

INSERT INTO ChiTietDatDichVu
VALUES ('PDP.040123.0001', 'DV.001.001', 1), ('PDP.040123.0001', 'DV.001.002', 2), ('PDP.040123.0001', 'DV.001.003', 3), ('PDP.040123.0002', 'DV.001.004', 4), ('PDP.040123.0002', 'DV.001.005', 5), ('PDP.040123.0002', 'DV.002.001', 1), ('PDP.040123.0002', 'DV.002.002', 2), ('PDP.040123.0002', 'DV.002.003', 3), ('PDP.050123.0001', 'DV.002.004', 4), ('PDP.050123.0001', 'DV.002.005', 5), ('PDP.050123.0001', 'DV.001.001', 1), ('PDP.050123.0001', 'DV.001.002', 2), ('PDP.050523.0001', 'DV.001.003', 3), ('PDP.050523.0001', 'DV.001.004', 4), ('PDP.050523.0001', 'DV.001.005', 5), ('PDP.050523.0001', 'DV.002.001', 1), ('PDP.050523.0001', 'DV.002.002', 2), ('PDP.050523.0001', 'DV.002.003', 3), ('PDP.060523.0001', 'DV.002.004', 4), ('PDP.060523.0001', 'DV.002.005', 5), ('PDP.060523.0001', 'DV.001.001', 1), ('PDP.060523.0001', 'DV.001.002', 2), ('PDP.060523.0001', 'DV.001.003', 3), ('PDP.060523.0001', 'DV.001.004', 4), ('PDP.060523.0002', 'DV.001.005', 5), ('PDP.060523.0002', 'DV.002.001', 1), ('PDP.060523.0002', 'DV.002.002', 2), ('PDP.060523.0002', 'DV.002.003', 3), ('PDP.060723.0001', 'DV.002.004', 4), ('PDP.060723.0001', 'DV.002.005', 5), ('PDP.060723.0001', 'DV.001.001', 1), ('PDP.070723.0001', 'DV.001.002', 2), ('PDP.070723.0001', 'DV.001.003', 3)
    GO
...
CREATE TRIGGER UpdateDichVuQuantity
    ON ChiTietDatDichVu AFTER INSERT
    AS
BEGIN
    SET
NOCOUNT ON;
UPDATE DichVu
SET SoLuong = DV.SoLuong - i.SoLuong FROM DichVu DV
...
IF
NOT EXISTS (SELECT 1 FROM PhieuDatPhong WHERE maPhong = @maPhong)
BEGIN
UPDATE PHONG
SET trangThai = 0
WHERE maPhong = @maPhong;
